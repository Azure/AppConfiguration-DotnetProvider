...
{
    internal class CompositeAzureAppConfigurationHealthCheck : IHealthCheck
    {
        ...
        public CompositeAzureAppConfigurationHealthCheck(IConfiguration configuration)
        {
        ...
        private void FindHealthChecks(IConfigurationRoot configurationRoot, List<IHealthCheck> healthChecks)
        {
            if (configurationRoot != null)
            {
                foreach (IConfigurationProvider provider in configurationRoot.Providers)
                {
                    ...
                    {
                        healthChecks.Add(appConfigurationProvider.HealthCheck);
                    }
