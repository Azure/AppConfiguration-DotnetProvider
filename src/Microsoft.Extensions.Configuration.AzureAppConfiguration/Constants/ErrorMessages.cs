...
namespace Microsoft.Extensions.Configuration.AzureAppConfiguration
{
    internal class ErrorMessages
    {
        ...
        public const string FeatureFlagInvalidJsonProperty = "Invalid property '{0}' for feature flag '{1}'. Found type: '{2}'. Expected type: '{3}'.";
        public const string FeatureFlagInvalidFormat = "Invalid json format for feature flag: '{0}'";
    }
}
