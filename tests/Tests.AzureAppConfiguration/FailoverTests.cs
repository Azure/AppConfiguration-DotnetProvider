...
namespace Tests.AzureAppConfiguration
{
    public class FailOverTests
    {
        ...
        public void FailOverTests_DoesNotReturnBackedOffClient()
        {
            ...
            Assert.Equal(2, configClientManager.GetClientWrappers().Where(c => c.BackoffEndTime > DateTimeOffset.UtcNow).Count());
            ...
            Assert.Single(configClientManager.GetClientWrappers().Where(c => c.BackoffEndTime > DateTimeOffset.UtcNow));
        }
        ...
        public void FailOverTests_ReturnsAllClientsIfAllBackedOff()
        {
            ...
            Assert.False(configClientManager.GetClientWrappers().Where(c => c.BackoffEndTime > DateTimeOffset.UtcNow).Any());
        }
        ...
        public void FailOverTests_GetNoDynamicClient()
        {
            ...
            var clients = configClientManager.GetClientWrappers().Where(c => c.BackoffEndTime > DateTimeOffset.UtcNow);
