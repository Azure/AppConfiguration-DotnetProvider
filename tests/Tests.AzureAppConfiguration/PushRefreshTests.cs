...
namespace Tests.AzureAppConfiguration
{
    ...
    {
        private static readonly Uri PrimaryResourceUri = new Uri(TestHelpers.PrimaryConfigStoreEndpoint.ToString() + "/kv/searchQuery1");
        private static readonly Uri SecondaryResourceUri = new Uri(TestHelpers.SecondaryConfigStoreEndpoint.ToString() + "/kv/searchQuery2");
        ...
        private readonly List<PushNotification> _pushNotificationList = new List<PushNotification>
            {
        ...
        private readonly List<PushNotification> _invalidPushNotificationList = new List<PushNotification>
            {
              new PushNotification  {
                                    ResourceUri = null,
                                    EventType = "eventType.KeyValueModified",
        ...
        private readonly Dictionary<string, EventGridEvent> _eventGridEvents = new Dictionary<string, EventGridEvent>
        {
            {
                "sn;Vxujfidne",
            new EventGridEvent(
        ...
        private readonly Dictionary<string, EventGridEvent> _invalidFormatEventGridEvents = new Dictionary<string, EventGridEvent>
        {
            {
                "sn;Vxujfidne",
            new EventGridEvent(
