    ...
    class Program
    {
        ...
        private static void Configure()
        {
            ...
            if (string.IsNullOrEmpty(configuration["AppConfigurationConnectionString"]))
            {
                ...
                Console.WriteLine("Please set the AppConfigurationConnectionString environment variable to a valid AppConfiguration connection string to and re-run this example.");
                return;
            }
            ...
            builder.AddAzconfig(o => {
                ...
                o.Connect(configuration["AppConfigurationConnectionString"])
                 //
